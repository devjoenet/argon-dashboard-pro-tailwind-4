        ...
        function (e, n, t) {
          (function (t) {
            ...
            function r(e, n) {
              ...
              function O(e) {
                ...
                if (!n) {
                  ...
                  r &&
                    ((ce = r),
                    c(),
                    'mousedown' === e.type && (p(t) ? t.focus() : e.preventDefault()));
                }
              }
              function N(e) {
                if (ce) {
              ...
              function B(e) {
                ($(e.item, e.source) &&
                  ((ie = e.item.cloneNode(!0)), le.emit('cloned', ie, e.item, 'copy')),
                  (Q = e.source),
                  (W = e.item),
                  (re = oe = g(e.item)),
                  (le.dragging = !0),
              ...
              function M(e, n) {
                ...
                (ie && fe.copySortSource && n === Q && t.removeChild(W),
                  k(n) ? le.emit('cancel', e, Q, Q) : le.emit('drop', e, n, Q, oe),
                  j());
              }
              function R() {
                if (le.dragging) {
              ...
              function U(e) {
                ...
                if (J) {
                  ...
                  ((null === m && s) || (m !== f && m !== g(f))) &&
                    ((oe = m), d.insertBefore(f, m), le.emit('shadow', f, d, Q));
                }
              }
              function _(e) {
                E.rm(e, 'gu-hide');
            ...
            function p(e) {
              return (
                'INPUT' === e.tagName || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName || m(e)
              );
            }
            function m(e) {
              return e
