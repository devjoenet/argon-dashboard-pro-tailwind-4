            ...
            ((this.prototype.Emitter = Emitter),
              ...
              (this.prototype.defaultOptions = {
                ...
                fallback: function () {
                  ...
                  e ||
                    ((e = C.createElement('<div class="dz-message"><span></span></div>')),
            ...
            value: function () {
              ...
              if (
                ...
                !(function l() {
                  return (
                    s.hiddenFileInput &&
                      s.hiddenFileInput.parentNode.removeChild(s.hiddenFileInput),
                    ...
                    null !== s.options.acceptedFiles &&
                      s.hiddenFileInput.setAttribute('accept', s.options.acceptedFiles),
                    null !== s.options.capture &&
                      s.hiddenFileInput.setAttribute('capture', s.options.capture),
                        ...
                        a.isFile
                          ? a.file(function (e) {
                              if (!u.options.ignoreHiddenFiles || '.' !== e.name.substring(0, 1))
                                return (
                                  (e.fullPath = ''.concat(s, '/').concat(e.name)),
                                  u.addFile(e)
                                );
                            })
                          : a.isDirectory &&
                            u._addFilesFromDirectory(a, ''.concat(s, '/').concat(a.name));
                      }
                    } catch (e) {
                      ((n = !0), (i = e));
                    } finally {
              ...
              (i.open(u, c, !0),
                ...
                (i.ontimeout = function () {
                  n._handleUploadError(
                    t,
                    i,
                    'Request timedout after '.concat(n.options.timeout, ' seconds')
                  );
                }),
                (i.onerror = function () {
                  ...
                  for (
                    ...
                    if (((s = s && s.toLowerCase()), null != l))
                      if ('SELECT' === a.tagName && a.hasAttribute('multiple')) {
                        ...
                        (!s || ('checkbox' !== s && 'radio' !== s) || a.checked) &&
                          e.append(l, a.value);
                  }
                } catch (e) {
                  ((n = !0), (i = e));
              ...
              if (void 0 !== n) {
                ...
                try {
                  for (var z, x = e[Symbol.iterator](); !(k = (z = x.next()).done); k = !0) {
                    var E = z.value;
                    ((100 === E.upload.progress && E.upload.bytesSent === E.upload.total) ||
                      (b = !1),
                      (E.upload.progress = i),
...
((Dropzone.createElement = function (e) {
  ...
  (Dropzone.getElement = function (e, t) {
    var n;
    if (
      ('string' == typeof e ? (n = document.querySelector(e)) : null != e.nodeType && (n = e),
      null == n)
    )
      throw new Error(
        'Invalid `'.concat(
