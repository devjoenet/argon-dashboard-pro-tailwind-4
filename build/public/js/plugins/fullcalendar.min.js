...
var FullCalendar = (function (e) {
  ...
  function b(e) {
    ((!e.__d && (e.__d = !0) && a.push(e) && !C.__r++) || l !== i.debounceRendering) &&
    ...
    for (
      ...
      if (
        ...
        ((E = I(e, g, (h = h || d), o, i, a, s, l, u)),
          (f = g.ref) &&
            h.ref != f &&
            (b || (b = []), h.ref && b.push(h.ref, null, g), b.push(f, g.__c || E, g)),
          null != E
            ? (null == D && (D = E),
              (l = R(e, g, h, C, a, E, l)),
        ...
        if (
          ...
          n.__c
            ...
            : ('prototype' in R && R.prototype.render
                ? (t.__c = d = new R(S, b))
                : ((t.__c = d = new E(S, b)), (d.constructor = R), (d.render = A)),
              D && D.sub(d),
              (d.props = S),
              d.state || (d.state = {}),
              (d.context = b),
  ...
  function N(e, t, n, r, o, i, a, s) {
    ...
    if (((o = 'svg' === t.type || o), null != i))
      for (l = 0; l < i.length; l++)
        if (
          null != (u = i[l]) &&
          ((null === t.type ? 3 === u.nodeType : u.localName === t.type) || e == u)
        ) {
          ((e = u), (i[l] = null));
          break;
        }
  ...
  function U(e, t, n) {
    ...
    (i.__ && i.__(e, t),
      ...
      I(
        ...
        n && !r ? [n] : o ? null : t.childNodes.length ? p.slice.call(t.childNodes) : null,
        a,
        n || d,
        r
      ),
  ...
  function Zt(e, t, n, r, o) {
    ...
    if (u)
      return (
        ((c = Jt(a, s, t ? t.sourceId : '', u.allDay, Boolean(u.duration), n)).recurringDef = {
          typeId: u.typeId,
          typeData: u.typeData,
          duration: u.duration,
        }),
  ...
  function In(e, t, n) {
    n.emitter.trigger(
      'select',
      r(r({}, Pn(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
    );
  }
  function Pn(e, t) {
    ...
    return (
      r(i, ((n = e), (o = t.dateEnv), r(r({}, xn(n.range, o, n.allDay)), { allDay: n.allDay }))),
      i
    );
  }
  function Nn(e, t, n) {
  ...
  function An(e, t, n, o, i) {
    ...
    return (
      ...
      l && (u.range = { start: u.range.start, end: Nn(t.allDay, u.range.start, i) }),
      t.allDay && (u.range = { start: we(u.range.start), end: we(u.range.end) }),
  ...
  var zn = (function () {
      ...
      return (
          ...
          if (e instanceof Bn) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({ type: 'ADD_EVENTS', eventStore: Ht({ def: n, instance: r }) }),
        ...
        (e.prototype.addEventSource = function (e) {
          ...
          var n = Wn(e, t);
          return n
            ? (this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [n] }), new V(t, n))
            : null;
        }),
    ...
    Bn = (function () {
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          else if ('id' === e) ((t = Gt[e](t)), this.mutate({ standardProps: { publicId: t } }));
          else if (e in Gt)
            ((t = Gt[e](t)), this.mutate({ standardProps: ((n = {}), (n[e] = t), n) }));
          else if (e in Vt) {
            var o = Vt[e](t);
            ('color' === e
      ...
      return (
        ...
        (e.prototype.createMarkerMeta = function (e) {
          ...
          return (
            ...
            null !== t && Ie(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } : null
          );
        }),
        ...
        (e.prototype.toDate = function (e, t) {
          return 'local' === this.timeZone
            ...
            : 'UTC' === this.timeZone
              ? new Date(e.valueOf())
              : this.namedTimeZoneImpl
                ? new Date(e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(xe(e)) * 60)
  ...
  function er(e) {
    for (
      var t = e.length > 0 ? e[0].code : 'en', n = $n.concat(e), r = { en: Qn }, o = 0, i = n;
      o < i.length;
      o++
    ) {
      var a = i[o];
  ...
  function wr(e, t) {
    ...
    return (
      Dr() && 'rtl' === n.direction ? (u.scrollbarLeft = l) : (u.scrollbarRight = l),
      t &&
  ...
  var To = (function () {
    ...
    return (
      ...
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Qe(n) <= 1 && this.isHiddenDay(o) && (o = we((o = this.skipHiddenDays(o, t)))),
          d(),
      ...
      (e.prototype._handleAction = function (e) {
        ...
        for (
          var p = Mo(n.eventSources, e, d, u),
            ...
            h = (xo(p) && !l.options.progressiveEventRendering && n.renderableEventStore) || f,
  ...
  var yi = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            var t = this.props, n = this.context.theme, i = [], a = !0, s = 0, l = e;
            s < l.length;
            s++
          ) {
            var u = l[s],
              ...
              f = u.buttonIcon;
            if ('title' === c)
              ((a = !1), i.push(Ar('h2', { className: 'fc-toolbar-title' }, t.title)));
            else {
          ...
          return Ar(
            ...
            function (t, n, o, i) {
              return Ar(
                'th',
                r(
                  { ref: t, className: u.concat(n).join(' '), colSpan: e.colSpan },
                  e.extraDataAttrs
                ),
                Ar(
                  'div',
          ...
          return Ar(
            ...
            n.map(function (e) {
              return o
                ...
                : Ar(Ii, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a });
            })
          );
        });
      }),
  ...
  var Ai = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, o = [], i = [], a = -1; n < r; )
          (t.isHiddenDay(n) ? o.push(a + 0.5) : ((a += 1), o.push(a), i.push(n)), (n = me(n, 1)));
    ...
    Li = (function () {
      ...
      return (
        ...
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
          return e
            ? this._sliceEventStore.apply(this, o([Ge(e, Wi(t, Boolean(n)), r), {}, t, n], i)).bg
            : [];
        }),
        ...
        (e.prototype._sliceDateSpan = function (e, t, n) {
          ...
          if (!e) return [];
          for (
            var a = _n(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s;
            l < u.length;
            l++
          ) {
            var c = u[l];
  ...
  function qi(e, t, n) {
    ...
    return 'function' == typeof t.content
      ...
      : Ar(
          ...
          n.tableColGroupNode,
          Ar('tbody', {}, 'function' == typeof t.rowContent ? t.rowContent(n) : t.rowContent)
        );
  }
  function Yi(e, t) {
    return at(e, t, Ve);
  ...
  var na = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        for (
          var l, u = r.length, c = 0, d = [], p = [], f = [];
          c < u && 'header' === (l = r[c]).type;
        )
          (d.push(this.renderSection(l, a)), (c += 1));
        for (; c < u && 'body' === (l = r[c]).type; ) (p.push(this.renderSection(l, a)), (c += 1));
        for (; c < u && 'footer' === (l = r[c]).type; )
          (f.push(this.renderSection(l, a)), (c += 1));
        var h = !pr();
        return Ar(
          'table',
          ...
          return Ar(
            ...
            function (t, o, i, a, s) {
              return Ar(
                ...
                Ar('div', { className: 'fc-event-main', ref: i, style: { color: s.textColor } }, a),
                s.isStartResizable &&
                  Ar('div', { className: 'fc-event-resizer fc-event-resizer-start' }),
                s.isEndResizable &&
                  Ar('div', { className: 'fc-event-resizer fc-event-resizer-end' })
              );
            }
          );
        }),
  ...
  function ia(e) {
    return Ar(
      ...
      Ar(
        ...
        Ar('div', { className: 'fc-event-title fc-sticky' }, e.event.title || Ar(Wr, null, ' '))
      )
    );
  }
  var aa = function (e) {
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            o.isRendered && ((o.isRendered = !1), zr(o.el), o.setClassNames([]), o.setHeight(''));
          Fr();
        }),
        (o.el = t),
    ...
    Sa = (function () {
      function e(e) {
        ...
        ((this.subjectEl = null),
          ...
          1 === (ya += 1) && window.addEventListener('touchmove', Da, { passive: !1 }));
      }
      return (
        (e.prototype.destroy = function () {
          (this.containerEl.removeEventListener('mousedown', this.handleMouseDown),
            ...
            (ya -= 1) || window.removeEventListener('touchmove', Da, { passive: !1 }));
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            (o < 0 ? (this.everMovedUp = !0) : o > 0 && (this.everMovedDown = !0),
              ...
              this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(Ta())));
          }
        }),
        ...
        ((n.dragSelection = null),
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            (e &&
              ...
              })(n.hitDragging.initialHit, e, o.pluginHooks.dateSelectionTransformers)) &&
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (In(n.dragSelection, e, n.component.context), (n.dragSelection = null));
          }));
            ...
            if (
              ...
              if (a === t) {
                ...
                (a.emitter.trigger('eventAdd', w),
                  ...
                  a.emitter.trigger(
                    'eventReceive',
                    r(r({}, w), { draggedEl: e.subjectEl, view: f.component.context.viewApi })
                  ));
              }
      ...
      ((n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, o) {
          ...
          (e &&
            ...
            d ? te() : ne(),
            t ||
              (u && Ia(s, e) && (u = null), (n.validMutation = u), (n.mutatedRelevantEvents = c)));
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
          ...
          (this.handleHitUpdate = function (e, t, o) {
            ...
            (e &&
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ...
                (l = !eo(u, a)) && ((u.mutatedEvents = { defs: {}, instances: {} }), (s = null)))),
              n.displayDrag(a, u),
          ...
          function (n, o) {
            return (
              ...
              Ar(
                ...
                Ar('a', r({ className: 'fc-daygrid-day-number' }, t), o || Ar(Wr, null, ' '))
              )
            );
          }
        );
            ...
            function (t, o, c, d) {
              return Ar(
                ...
                Ar(
                  ...
                  i.showWeekNumber &&
                    Ar(ha, { date: a, defaultFormat: Ja }, function (e, t, n, o) {
                      return Ar(
                        'a',
                        r({ ref: e, className: ['fc-daygrid-week-number'].concat(t).join(' ') }, u),
                        o
                      );
                    }),
                  !d &&
  ...
  function rs(e) {
    return Ar(
      ...
      e.timeText && Ar('div', { className: 'fc-event-time' }, e.timeText),
      Ar('div', { className: 'fc-event-title' }, e.event.title || Ar(Wr, null, ' '))
    );
  }
  var os = (function (e) {
    function t() {
      ...
      for (var S = 0, D = 0, b = 0, C = u[E]; b < C.length; b++) {
        ...
        d[(w = R.seg).eventRange.instance.instanceId] ||
          ...
          w.firstCol === w.lastCol && w.isStart && w.isEnd
            ? ((f[w.eventRange.instance.instanceId] = R.top - S), (D = 0), (S = R.bottom))
            : (D = R.bottom - S));
      }
      D && (c[E] ? (h[E] = D) : (v[E] = D));
    }
    ...
    return {
      ...
      segsByEachCol: u.map(function (t, n) {
        ...
        return (o = (function (e, t, n) {
          for (
            var o = t, i = me(o, 1), a = { start: o, end: i }, s = [], l = 0, u = e;
            l < u.length;
            l++
          ) {
            var c = u[l],
  ...
  var ls = (function (e) {
    function t() {
      ...
      return (
        ...
        (t.rootElRef = Lr()),
        (t.state = { framePositions: null, maxContentHeight: null, segHeights: {} }),
        t
      );
    }
    return (
                ...
                Ar(
                  ...
                  ts(m)
                    ? Ar(
                        ns,
                        r(
                          { seg: m, isDragging: s, isSelected: y === d, defaultDisplayEventEnd: f },
                          bn(m, a)
                        )
                      )
                    : Ar(
        ...
        if (a)
          for (var l = 0, u = e; l < u.length; l++) {
            ...
            s.push(
              Ar(
                'div',
                { key: wn(c.eventRange), className: 'fc-daygrid-bg-harness', style: d },
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ...
            Ar('div', { className: 'fc-popover-body ' + e.getClass('popoverContent') }, t.children)
          );
        }),
        (t.prototype.componentDidMount = function () {
          ...
          return Ar(
            ...
            function (e, t, n) {
              return Ar(
                ...
                Ar(la, { date: i, dateProfile: l, todayRange: s }, function (e, t) {
        ...
        (t.prototype.positionToHit = function (e, t, n) {
          ...
          return l >= 0 && l < i.width && u >= 0 && u < i.height
            ? {
                ...
                dayEl: r,
                relativeRect: { left: a, top: s, right: i.width, bottom: i.height },
                layer: 1,
              }
            : null;
        }),
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              a = Se(i.start, i.end),
              s = o.navLinks && 1 === a ? { 'data-navlink': yr(i.start, 'week'), tabIndex: 0 } : {};
            return o.weekNumbers && 'day' === e
              ? Ar(ha, { date: i.start, defaultFormat: ws }, function (e, t, o, i) {
                  return Ar(
                    'th',
                    {
                      ref: e,
              ...
              : Ar(
                  ...
                  Ar('div', { className: 'fc-timegrid-axis-frame', style: { height: n } })
                );
          }),
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t, n) {
          ...
          return (
            ...
            Ar(Do, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
              return Ar(
                'div',
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r, o, i, a) {
          ...
          return (
                      ...
                      Ar(
                        ...
                        Ar(Pi, { unit: h ? 'minute' : 'day' }, function (e) {
                          ...
                          return 'number' == typeof t
                            ? Ar(aa, { isAxis: !0, date: e }, function (e, n, r, o) {
                                return Ar(
                                  'div',
                                  {
                                    ref: e,
            ...
            Ar(Do, { viewSpec: u.viewSpec, elRef: this.rootElRef }, function (e, t) {
              return Ar(
                'div',
                { className: ['fc-timegrid'].concat(t).join(' '), ref: e },
                Ar(l, {
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ...
            Ar(
              ...
              e.tableColGroupNode,
              Ar(Ms, { slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas })
            )
          );
        }),
        (t.prototype.componentDidMount = function () {
          ...
          ((function (e) {
            ...
            for (t = 0; t < e.length; t += 1)
              for (n = e[t], r = 0; r < n.length; r += 1)
                for ((o = n[r]).forwardSegs = [], i = t + 1; i < e.length; i += 1)
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Ar(oa, r({}, this.props, { defaultTimeFormat: Ls, extraClassNames: e }))
          );
        }),
        t
      );
      ...
      return (
              ...
              return Ar(
                ...
                Ar(
                  ...
                  Ar(
                    'div',
                    { className: 'fc-timegrid-col-events' },
                    e.renderFgSegs(o, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(n))
                  ),
                  Ar(
                    'div',
                    { className: 'fc-timegrid-now-indicator-container' },
        ...
        (t.prototype.renderPrintFgSegs = function (e) {
          ...
          return (e = gn(e, this.context.options.eventOrder)).map(function (e) {
            return Ar(
              'div',
              { className: 'fc-timegrid-event-harness', key: e.eventRange.instance.instanceId },
              Ar(
                Ws,
                r(
                  {
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          var a = e.map(function (e) {
            return Ar(
              ...
              'bg-event' === t ? Ar(pa, r({ seg: e }, bn(e, i.todayRange, i.nowDate))) : da(t)
            );
          });
          return Ar(Wr, null, a);
        }),
        ...
        (t.prototype.computeFgSegPositionCss = function (e) {
          ...
          return (
            a && e.forwardPressure && (u[i ? 'marginLeft' : 'marginRight'] = 20),
                    ...
                    Ar(
                      ...
                      Ar(
                        ...
                        Ar(
                          ...
                          { className: 'fc-timegrid-now-indicator-container' },
                          'number' == typeof n &&
                            Ar(aa, { isAxis: !0, date: t.nowDate }, function (e, t, r, o) {
                              return Ar(
                                'div',
                                {
                                  ref: e,
  ...
  function Xs(e, t, n, r, o) {
    for (
      ...
      var c = o.add(i, a),
        d = null !== tt(s, l);
      (u.push({ date: c, time: a, key: c.toISOString(), isoTimeStr: ot(c), isLabeled: d }),
        (a = Je(a, r)),
        (s = Je(s, r)));
    }
    return u;
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ...
            function (e, n, r, o) {
              return Ar(
                'tr',
                { ref: e, className: h.concat(n).join(' '), 'data-date': rt(t) },
                Ar(
                  'th',
                  { colSpan: 3 },
                  Ar(
                    'div',
                    { className: 'fc-list-day-cushion ' + i.getClass('tableCellShaded'), ref: r },
                    o
                  )
                )
              );
  ...
  function el(e) {
    ...
    return Ar(
      ...
      e.sideText && Ar('a', r({ className: 'fc-list-day-side-text' }, t), e.sideText)
    );
  }
          ...
          return Ar(
            ...
            function (e, o, i, a, s) {
              return Ar(
                'tr',
                {
                  className: ['fc-list-event', s.event.url ? 'fc-event-forced-url' : '']
                    .concat(o)
                    .join(' '),
                  ref: e,
                },
                    ...
                    if (
                      ...
                      return Ar(
                        ...
                        function (e, t, n, r) {
                          return Ar(
                            'td',
                            { className: ['fc-list-event-time'].concat(t).join(' '), ref: e },
                            r
                          );
                        }
                      );
    ...
    return (
      ...
      (t.prototype._eventStoreToSegs = function (e, t, n) {
        return this.eventRangesToSegs(
          cn(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg,
          n
        );
      }),
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = me(e.start, -1).toISOString()), (s = me(e.end, 1).toISOString()));
                ((i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
