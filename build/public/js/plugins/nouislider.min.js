    ...
    (t.prototype.handleStepPoint = function (t, e) {
      e &&
        (this.xVal[t] !== this.xVal[t + 1]
          ? ((this.xSteps[t] =
              a([this.xVal[t], this.xVal[t + 1]], e, 0) / s(this.xPct[t], this.xPct[t + 1])),
  ...
  function j(t, f, o) {
    ...
    function C(t, e) {
      ...
      return (
        ...
        0 === e
          ? dt(n, f.cssClasses.handleLower)
          : e === f.handles - 1 && dt(n, f.cssClasses.handleUpper),
        t
      );
    }
    function N(t, e) {
        ...
        return (
          ...
          !(
            (e.classList
              ...
              : new RegExp('\\b' + t + '\\b').test(e.className)) && !s.doNotReject
          ) &&
      ...
      var i,
        ...
        r =
          ...
          a.forEach(function (t, e) {
            ...
            k(e) ||
              ((r = m[e]),
              ((n = Math.abs(r - i)) < o || (n <= o && r < i) || (100 === n && 100 === o)) &&
                ((s = e), (o = n)));
          }),
          s);
      !1 !== r &&
    ...
    function I(t) {
      ...
      Object.keys(b).forEach(function (t) {
        ...
        (n && n !== e) ||
          (i && i !== r) ||
          ((((e = r) !== gt.aria && e !== gt.tooltips) || i === r) && delete b[t]);
      });
    }
    function W(r, n, i) {
      Object.keys(b).forEach(function (t) {
    ...
    function $(t, e, r, n, i, o) {
      ...
      return (
        1 < a.length &&
          ...
          (n &&
            0 < e &&
            ((s = S.getAbsoluteDistance(t[e - 1], f.margin, !1)), (r = Math.max(r, s))),
          i &&
            e < a.length - 1 &&
            ((s = S.getAbsoluteDistance(t[e + 1], f.margin, !0)), (r = Math.min(r, s)))),
        1 < a.length &&
          f.limit &&
          (n && 0 < e && ((s = S.getAbsoluteDistance(t[e - 1], f.limit, !1)), (r = Math.min(r, s))),
          i &&
            e < a.length - 1 &&
            ((s = S.getAbsoluteDistance(t[e + 1], f.limit, !0)), (r = Math.max(r, s)))),
        f.padding &&
          (0 === e && ((s = S.getAbsoluteDistance(0, f.padding[0], !1)), (r = Math.max(r, s))),
          e === a.length - 1 &&
            ((s = S.getAbsoluteDistance(100, f.padding[1], !0)), (r = Math.min(r, s)))),
    ...
    function tt(t) {
      ...
      l[t] &&
        ...
        (e =
          'translate(' +
          G(
            K((e = (e = 0) !== t ? m[t - 1] : e), (r = (r = t !== l.length - 1 ? m[t] : r) - e)) +
              '%',
            '0'
          ) +
          ')'),
