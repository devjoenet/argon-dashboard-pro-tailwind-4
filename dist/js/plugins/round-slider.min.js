        ...
        if ((c++, 1 === t.nodeType)) {
          if (t.hasAttributes()) {
            ...
            for (; i-- > 0; ) {
              ...
              t.removeAttribute(i);
              const o = r.split(n);
              (this.parts.push({ type: 'attribute', index: c, name: s, strings: o }),
                (u += o.length - 1));
            }
          }
    ...
    for (; o < i.length; )
      if (((r = i[o]), a(r))) {
        ...
        if ('node' === r.type) {
          ...
          this.__parts.push(
            ...this.processor.handleAttributeExpressions(l, r.name, r.strings, this.options)
          );
        o++;
    ...
    (s
      ? (function (t, e, s = null) {
          ...
          for (; r.nextNode(); ) {
            h++;
            for (
              r.currentNode === s && ((a = c(e)), s.parentNode.insertBefore(e, s));
              -1 !== o && n[o].index === h;
            ) {
              if (a > 0) {
...
customElements.define(
  ...
  class extends Q {
    ...
    _value2angle(t) {
      const e =
        ((t = Math.min(this.max, Math.max(this.min, t))) - this.min) / (this.max - this.min);
      return this._start + e * this._len;
    }
    _angle2value(t) {
      return (
        Math.round(((t / this._len) * (this.max - this.min) + this.min) / this.step) * this.step
      );
    }
    get _boundaries() {
    ...
    drag(t) {
      ...
      if (this._rotation.cooldown)
        return (window.clearTimeout(this._rotation.coldown), void this._cleanupRotation());
