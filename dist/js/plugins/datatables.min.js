              ...
              var d = b(function (q, w) {
                  ...
                  q.exports =
                    ...
                    ((e = {
                      ...
                      p: function (a) {
                        return (
                          { M: j, y: k, w: r, d: 'day', D: l, h: i, m: h, s: g, ms: f, Q: s }[a] ||
                          String(a || '')
                            .toLowerCase()
                            .replace(/s$/, '')
                        );
                    ...
                    (e.i = c),
                    (e.w = function (c, b) {
                      return a(c, { locale: b.$L, utc: b.$u, x: b.$x, $offset: b.$offset });
                    }),
                    (p = (v = (function () {
                      function m(a) {
                      ...
                      return (
                            ...
                            b = function (a, b) {
                              return e.w(
                                u
                                  ...
                                  [
                                    a
                                  ].apply(u.toDate('s'), (d ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(b)),
                                u
                              );
                            },
                            f = this.$W,
                        ...
                        (c.$set = function (p, n) {
                          ...
                          if (c === j || c === k) {
                            ...
                            (d.$d[m](o),
                              d.init(),
                              (this.$d = d.set(l, Math.min(this.$D, d.daysInMonth())).$d));
                          } else m && this.$d[m](o);
                  ...
                  f.exports =
                    ...
                    (h = function (a, b) {
                      return a.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function (e, c, a) {
                        ...
                        return (
                          ...
                          b[a] ||
                          g[a] ||
                          b[d].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (c, a, b) {
                            return a || b.slice(1);
                          })
                        );
                      });
                    ...
                    (n = function (q, r, s) {
                      try {
                        var a = (function (d) {
                            for (
                              var c = (d = h(d, j && j.formats)).match(i), g = c.length, a = 0;
                              a < g;
                              a += 1
                            ) {
                              var e = c[a],
                                ...
                                k = b && b[0],
                                f = b && b[1];
                              c[a] = f ? { regex: k, parser: f } : e.replace(/^\[|\]$/g, '');
                            }
                            return function (b) {
                              ...
                              return (
                                (function (a) {
                                  ...
                                  if (void 0 !== b) {
                                    var c = a.hours;
                                    (b ? c < 12 && (a.hours += 12) : 12 === c && (a.hours = 0),
                                      delete a.afternoon);
                                  }
                                })(d),
                                d
                        ...
                        var k = u || 0,
                          ...
                          o = x || 0;
                        return p
                          ? new Date(Date.UTC(g, c, f, k, l, n, o + 60 * p.offset * 1e3))
                          : s
                      ...
                      a.parse = function (f) {
                        ...
                        if ('string' == typeof b) {
                          ...
                          (m && (d = a[2]),
                            ...
                            p && i !== this.format(b) && (this.$d = new Date('')),
                            (j = {}));
      ...
      2: [
        function (c, d, a) {
          ...
          let e = (a) => '[object Object]' === Object.prototype.toString.call(a),
            ...
            h = (a, b, c) => f('li', { class: a, html: `<a href="#" data-page="${b}">${c}</a>` }),
            i = (a, c) => {
              let d, e;
          ...
          class k {
            ...
            add(a) {
              ...
              if (!this.dt.headings.length)
                return (
                  this.dt.insert({ headings: [a.heading], data: a.data.map((a) => [a]) }),
                  void this.rebuild()
                );
              (this.dt.hiddenHeader
                ...
                this.dt.data.forEach((d, b) => {
                  a.data[b] &&
                    ...
                    a.data[b].nodeName ? c.appendChild(a.data[b]) : (c.innerHTML = a.data[b]),
                    (c.data = c.innerHTML),
                    a.render && (c.innerHTML = a.render.call(this, c.data, c, d)),
                    d.appendChild(c));
                }),
                ...
                a.hasOwnProperty('sortable') &&
                  ...
                  b.setAttribute('data-sortable', !0 === a.sortable ? 'true' : 'false')),
                this.rebuild(),
            ...
            filter(b, c, d, e) {
              let a = this.dt;
              if (
                (a.filterState || (a.filterState = { originalData: a.data }), !a.filterState[b])
              ) {
                let h = [...e, () => !0],
                  f;
            ...
            sort(b, f, g) {
              ...
              if ('date' === e.getAttribute('data-type')) {
                let j = !1;
                (e.hasAttribute('data-format') && (j = e.getAttribute('data-format')),
                  h.push(
                    Promise.resolve()
                      .then(function () {
              ...
              Promise.all(h).then((h) => {
                ...
                (Array.from(k).forEach((c) => {
                  let d = c.cells[b],
                    ...
                    e;
                  parseFloat(
                    (e = p ? p(a) : 'string' == typeof a ? a.replace(/(\$|,|\s|%)/g, '') : a)
                  ) == e
                    ? (m[o++] = { value: Number(e), row: c })
                    : (l[n++] = { value: 'string' == typeof a ? a.toLowerCase() : a, row: c });
                }),
                  ...
                  a.lastTh &&
                    e != a.lastTh &&
                    (a.lastTh.classList.remove('desc'), a.lastTh.classList.remove('asc')),
                  (a.lastTh = e),
                  (k = c.concat(d)),
                  (a.data = []));
                let j = [];
                (k.forEach((b, c) => {
                  (a.data.push(b.row),
                    null !== b.row.searchIndex && void 0 !== b.row.searchIndex && j.push(c));
                }),
                  (a.searchData = j),
                  this.rebuild(),
                  a.update(),
                    ...
                    Array.from(g.cells).forEach((b) => {
                      (((e = b.cloneNode(!0)).data = b.data),
                        ...
                        a.hiddenColumns.includes(e.cellIndex) ||
                          (((f = e.cloneNode(!0)).data = e.data), d.appendChild(f)));
                    }),
                    b.push(c),
                    a.activeRows.push(d));
                }),
          ...
          let l = function (a) {
              ...
              (a.data &&
                ...
                b &&
                  (null !== this.table.tHead && this.table.removeChild(this.table.tHead),
                  this.table.appendChild(b)),
                c &&
                  (this.table.tBodies.length && this.table.removeChild(this.table.tBodies[0]),
          ...
          class b {
            constructor(a, b = {}) {
              if (
                ...
                null !== a.tHead ||
                  (this.options.data && (!this.options.data || this.options.data.headings)) ||
                ...
                setTimeout(() => {
                  (this.emit('datatable.init'),
                    ...
                    this.options.plugins &&
                      Object.entries(this.options.plugins).forEach(([a, b]) => {
                        this[a] &&
                          'function' == typeof this[a] &&
                          ((this[a] = this[a](b, { createElement: f })),
                          b.enabled &&
                            this[a].init &&
            ...
            render(d) {
              ...
              if (
                ...
                this.body || ((this.body = f('tbody')), this.table.appendChild(this.body)),
              ...
              if (
                ...
                (this.wrapper = f('div', { class: 'dataTable-wrapper dataTable-loading' })),
                ...
                (b += a.layout.bottom),
                (b += '</div>'),
                (b = b.replace('{info}', a.paging ? "<div class='dataTable-info'></div>" : '')),
            ...
            renderPage() {
              if (
                (this.hasHeadings &&
                  (g(this.header), this.activeHeadings.forEach((a) => this.header.appendChild(a))),
              ...
              if (
                (this.totalPages &&
                  ((d =
                    (b = (c = this.currentPage - 1) * this.options.perPage) + this.pages[c].length),
                  (b += 1),
                  (a = this.searching ? this.searchData.length : this.data.length)),
            ...
            renderPager() {
              if ((g(this.pagers), this.totalPages > 1)) {
                ...
                (this.options.firstLast && b.appendChild(h(a, 1, this.options.firstText)),
                  this.options.nextPrev && b.appendChild(h(a, d, this.options.prevText)));
                let c = this.links;
                (this.options.truncatePager &&
                      ...
                      i.forEach((a) => {
                        ...
                        if (n) {
                          ...
                          if (c - b == 2) l.push(k[b]);
                            ...
                            let d = f('li', { class: 'ellipsis', html: `<a href="#">${m}</a>` });
                            l.push(d);
                          }
                        }
                        (l.push(a), (n = a));
                  ...
                  this.links[this.currentPage - 1].classList.add('active'),
                  this.options.nextPrev && b.appendChild(h(a, e, this.options.nextText)),
                ...
                this.headings &&
                  ...
                  this.headings.forEach((a, b) => {
                    if (
                      ...
                      a.firstElementChild &&
                        a.firstElementChild.classList.contains('dataTable-sorter') &&
                        (a.innerHTML = a.firstElementChild.innerHTML),
                      (a.sortable = 'false' !== a.getAttribute('data-sortable')),
                      (a.originalCellIndex = b),
                      this.options.sortable && a.sortable)
                    ) {
                      let c = f('a', { href: '#', class: 'dataTable-sorter', html: a.innerHTML });
            ...
            bindEvents() {
              ...
              (a.searchable &&
                ...
                this.input &&
                  this.input.addEventListener('keyup', () => this.search(this.input.value), !1)),
                  ...
                  (c) => {
                    ...
                    b &&
                      ...
                      (b.hasAttribute('data-page')
                        ? (this.page(b.getAttribute('data-page')), c.preventDefault())
                        : a.sortable &&
                          b.classList.contains('dataTable-sorter') &&
                          'false' != b.parentNode.getAttribute('data-sortable') &&
                          (this.columns().sort(this.headings.indexOf(b.parentNode)),
                          c.preventDefault()));
                  },
                  !1
                ),
                  ...
                  this.options.columns.forEach((a) => {
                    (Array.isArray(a.select) || (a.select = [a.select]),
                      a.hasOwnProperty('render') &&
                        ...
                        ((this.selectedColumns = this.selectedColumns.concat(a.select)),
                        this.columnRenderers.push({ columns: a.select, renderer: a.render })),
                      a.select.forEach((c) => {
                        ...
                        (a.type && b.setAttribute('data-type', a.type),
                          ...
                          a.hasOwnProperty('hidden') && !1 !== a.hidden && this.columns().hide([c]),
                          a.hasOwnProperty('sort') &&
                            1 === a.select.length &&
                            this.columns().sort(a.select[0], a.sort, !0));
                      }));
                  }),
                this.hasRows &&
                        ...
                        this.selectedColumns.includes(b) &&
                          this.columnRenderers.forEach((d) => {
                            d.columns.includes(b) &&
                              (c.innerHTML = d.renderer.call(this, c.data, c, a));
                          });
                      });
                    }),
            ...
            paginate() {
              ...
              return (
                this.searching &&
                  ((a = []), this.searchData.forEach((b) => a.push(this.activeRows[b]))),
                this.options.paging
                  ? (this.pages = a
              ...
              if (
                ...
                if (((this.columnWidths = []), this.table.tHead)) {
                  if (
                    ...
                    if (!this.headerTable) {
                      this.headerTable = f('table', { class: 'dataTable-table' });
                      let d = f('div', { class: 'dataTable-headercontainer' });
                    ...
                    (this.table.replaceChild(a, e),
                      ...
                      (this.headerTable.parentElement.style.paddingRight =
                        ...
                        parseInt(this.headerTable.parentElement.style.paddingRight || '0', 10) +
                        'px'),
                      b.scrollHeight > b.clientHeight && (b.style.overflowY = 'scroll'));
                  }
                } else {
                  ((c = []), (a = f('thead')));
                  let g = f('tr');
            ...
            page(a) {
              return (
                ...
                !(a > this.pages.length || a < 0) &&
                  (this.render('page'), this.render('pager'), void this.emit('datatable.page', a)))
              );
            }
            sortColumn(a, b) {
            ...
            clear(a) {
              ...
              (this.body || (b = this.table),
                a &&
                  ('string' == typeof a && (document.createDocumentFragment().innerHTML = a),
                  b.appendChild(a)));
            }
            export(k) {
              ...
              if (b.type) {
                ...
                if (f.length) {
                  if ('txt' === b.type || 'csv' === b.type) {
                    ...
                    for (a = `INSERT INTO \`${b.tableName}\` (`, c = 0; c < g.length; c++)
                      !b.skipColumn.includes(g[c].originalCellIndex) &&
                        this.columns(g[c].originalCellIndex).visible() &&
                        (a += `\`${g[c].textContent}\`,`);
                    for (
                      a = a.trim().substring(0, a.length - 1), a += ') VALUES ', c = 0;
                      c < f.length;
                      c++
                    ) {
                    ...
                    ((a = a.trim().substring(0, a.length - 1)),
                      (a += ';'),
                      b.download && (a = 'data:application/sql;charset=utf-8,' + a));
                  } else if ('json' === b.type) {
                    for (d = 0; d < f.length; d++)
                      for (j[d] = j[d] || {}, c = 0; c < g.length; c++)
                        !b.skipColumn.includes(g[c].originalCellIndex) &&
                          this.columns(g[c].originalCellIndex).visible() &&
                          (j[d][g[c].textContent] = f[d].cells[c].textContent);
                    ((a = JSON.stringify(j, b.replacer, b.space)),
                      b.download && (a = 'data:application/json;charset=utf-8,' + a));
                  }
                  return (
                    b.download &&
            ...
            import(d) {
              ...
              if (a.data.length || e(a.data)) {
                if ('csv' === a.type) {
                  ...
                  c.length &&
                    (a.headings && ((b.headings = c[0].split(a.columnDelimiter)), c.shift()),
                    c.forEach((d, e) => {
                      b.data[e] = [];
            ...
            setMessage(b) {
              ...
              (this.hasRows
                ...
                this.render('pager'),
                this.clear(
                  f('tr', { html: `<td class="dataTables-empty" colspan="${a}">${b}</td>` })
                ));
            }
            columns(a) {
              return new k(this, a);
            ...
            off(a, b) {
              ((this.events = this.events || {}),
                a in this.events != 0 && this.events[a].splice(this.events[a].indexOf(b), 1));
            }
            emit(a) {
