...
(!(function (e, t) {
        ...
        (function (e, t, n, o) {
          ...
          (W([e, t, n], h.styled),
            o.confirmButtonColor &&
              ((e.style.backgroundColor = o.confirmButtonColor), W(e, h['default-outline'])));
          o.denyButtonColor &&
            ((t.style.backgroundColor = o.denyButtonColor), W(t, h['default-outline']));
          o.cancelButtonColor &&
            ((n.style.backgroundColor = o.cancelButtonColor), W(n, h['default-outline']));
        })(i, a, s, t),
  ...
  const me = (e, t) => {
    ...
    i &&
      ...
      !t.backdrop &&
        t.allowOutsideClick &&
        s('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
      (o = i),
      (n = t.position) in h
        ? W(o, h[n])
        : (s('The "position" parameter is not valid, defaulting to "center"'), W(o, h.center)),
      (n = i),
  ...
  const Ae = (e, t) => {
    ...
    Te = (e, t) => {
      ((e.className = ''.concat(h.popup, ' ').concat(G(e) ? t.showClass.popup : '')),
        t.toast
          ? (W([document.documentElement, document.body], h['toast-shown']), W(e, h.toast))
          : W(e, h.modal),
        U(e, t, 'popup'),
    ...
    Le = (e, t) => {
      ...
      (((e) => {
        ...
        const n = v();
        (e.toast
          ? (Y(t, 'width', e.width), (n.style.width = '100%'), n.insertBefore(S(), w()))
          : Y(n, 'width', e.width),
  ...
  const Xe = () => {
    ...
    et = (e) => {
      ...
      return (
        !tt(e) &&
        !nt(e) &&
        (t === n || !(ee(n) || 'INPUT' === t.tagName || (ee(k()) && k().contains(t))))
      );
    },
  ...
  function it(e, t, n, o) {
    (q()
      ...
      M() &&
        (null !== H.previousBodyPadding &&
          ((document.body.style.paddingRight = ''.concat(H.previousBodyPadding, 'px')),
  ...
  const mt = ['swal-title', 'swal-html', 'swal-footer'],
    ...
    Tt = (e) =>
      e.files.length ? (null !== e.getAttribute('multiple') ? e.files : e.files[0]) : null,
    Lt = (t, n) => {
      const o = v(),
      ...
      return (
        ...
        new Promise((e) => {
          ...
          (ot.swalPromiseResolve.set(s, e),
            ...
            (a = r),
            (e = t),
            he.innerParams.get(n).toast ? Jt(n, a, e) : (Xt(a), Gt(a), Qt(n, a, e)),
            (o = s),
            (a = Me),
            (e = c),
            (i = t),
